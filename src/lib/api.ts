...
/* ════════════════════════════════════════════════
   Consultation endpoint (laws_only RAG)
   ════════════════════════════════════════════════ */
...
function mockSendConsultationChat(_message: string): Promise<ConsultationChatResponse> {
  return Promise.resolve({
    session_id: null,
    reply: 'عذرًا، لا يمكن معالجة الاستشارة حاليًا — الخادم غير متصل. قم بتوصيل الباك إند عبر متغير VITE_API_BASE_URL في ملف .env لتشغيل الاستشارات بالذكاء الاصطناعي.',
